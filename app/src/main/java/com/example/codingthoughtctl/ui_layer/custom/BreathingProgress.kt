package com.example.codingthoughtctl.ui_layer.custom
...
class BreathingProgress(
    ...
    private fun createProgress(context: Context) {
        ...
        fixedRingLayout.setBackgroundResource(R.drawable.awesome_progress)
        ...
        breathingCircleLayout.setBackgroundResource(R.drawable.shape_circle)
